...
- **[Game Rules](docs/game-rules.md)** - Canonical version for the printed board game and human players (source of truth). The AI players are prompted with an auto-synced copy of this file (`simulation/public/prompts/game-rules.md`, generated by `npm run sync-rules`).
- **[Simulator Notes](simulation/public/prompts/simulator-notes-for-ai.md)** - Deliberate simulator deviations from the printed rules (no player-to-player trading, no negotiation, etc.)
...
# Choose a Claude model: haiku, sonnet (default), opus, or fable
node run-test.js --single-turn --p1 claude:opus
