...
**(3)** \`+3 might\` against **dragons**`,
  ...
  },
  {
    ...
    name: "Porcupine",
    tier: 2,
    description: "If the opponent's **combat total** is higher than yours (dice, might, support, and items all count), this *shield* grants `+2 might`.",
    count: 1,
    carriable: true,
    theme: "grove",
...
**(6)** You gain **Cloudslicer** which gives \`+4 might\``,
  ...
  },
  {
    ...
    tier: 2,
    description: "A dragon egg, lost long ago. Carry it to **Doomspire** and return it to *impress the dragon* once, as if you had reached one of the four win-conditions. The egg is then gone.",
    count: 1,
    carriable: true,
    imagePromptGuidance: "A large, majestic dragon egg with glowing cracks, resting on rocky ground",
  },
  {
...
**(3)** Move on`,
  ...
  // Tier 3 Treasure Cards
  {
    ...
    name: "The one ring",
    tier: 3,
    description: "Grants `+2 might`. Any *knight* with both the *one* and the *second* ring may **impress the dragon** as if they had reached one of the four win-conditions. If you also possess *the mysterious ring* while doing so, **the game immediately ends** as you absorb the dragons essence and take its place as the new ruler.",
    count: 1,
    carriable: true,
    theme: "cave"
  },
  {
    ...
    tier: 3,
    description: "Gives `+2 fame`. Any *knight* with both the *one* and the *second* ring may **impress the dragon** as if they had reached one of the four win-conditions. If you also posess *the mysterious ring* while doing so, **the game immediately ends** as you absorb the dragons essence and take its place as the new ruler.",
    count: 1,
    carriable: true,
    theme: "grove"
  },
